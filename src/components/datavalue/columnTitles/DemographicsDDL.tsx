import { DemographicsFields } from "./DemographicsColumns";
...
export const getUniqueOptionsSingle = (rows: DemographicsFields[], valueKey: string) => {
  ...
  // function to generate the default value for demographics fields
export const getDemographicsDefaultValue =  {
  id: '', ACCT: '', FYE: '', BNK: '', NAME: '', FREQX: '', SECPKG: '', INDXPKG: '', REPTPKG: '', SECTPKG: '',
